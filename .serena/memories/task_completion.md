...
- New NixOS sub-modules go in `nix/modules/nixos/` and import from `nixos.nix`
- New home-manager modules go in `nix/modules/home/` and import from `home-manager.nix`
