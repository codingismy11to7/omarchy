        ...
        type = submodule {
          options = {
            ...
            lockSeconds = mkOption {
              type = int;
              default = 151; # 1 second after screensaver activation
              example = 900;
              description = "Seconds of inactivity before locking the screen.";
            };
            screenOffSeconds = mkOption {
              type = int;
              default = 330; # 3 minutes after screensaver activation
              example = 600;
              description = "Seconds of inactivity before turning off the screen.";
            };
          };
        };
        default = { };
