...
let
  ...
  cloneDotfilesSh = path { path = ../install/packaging/phases/clone-dotfiles.sh; };
  configureSecretsSh = path { path = ../install/packaging/phases/configure-secrets.sh; };
  installSystemSh = path { path = ../install/packaging/phases/install-system.sh; };
  nixInstallShRaw = path { path = ../install/packaging/nix-install.sh; };
      ...
      modules = [
        ...
        (
          ...
          let
            ...
            nixInstallSh = replaceVars nixInstallShRaw {
              inherit cloneDotfilesSh configureSecretsSh installSystemSh;
            };
